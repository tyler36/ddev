...
* Download the config.zip. Visit /admin/config/search/search-api dashboard, clicking on drop-down button next to "edit" for you sever and select "get config.zip". THen click the "+ Get config.zip" button.
